...
object DatePatterns {
    ...
    const val FULL_DATE = "yyyy-MM-dd" // Full date (2024-08-22)
    const val DATE_WITH_MONTH_NAME = "dd MMM yyyy" // Date with month abbreviation (22 Aug 2024)
    const val FULL_DATE_TIME = "yyyy-MM-dd HH:mm:ss" // Full date and time (2024-08-22 17:45:09)
    const val TIME_HOUR_MINUTE = "HH:mm" // Time in hours and minutes (17:45)
    const val TIME_HOUR_MINUTE_AM_PM = "h:mm a" // Time in hours and minutes (17:45)
    const val DATE_WITH_DAY = "EEEE, d MMMM yyyy" // Date with day name (Monday, 22 August 2024)
...
fun LocalDateTime.formatToCustomPattern(pattern: String = DatePatterns.DATE_DAY_MONTH): String {
